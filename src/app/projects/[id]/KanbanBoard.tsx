        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 -mt-3">
            <div className="flex items-center">
              <div
                onClick={(e) => e.stopPropagation()}
                className="mr-6 flex items-center cursor-pointer select-none border border-gray-300 rounded-md px-2 py-1 hover:bg-gray-50 transition-colors"
              >
                <Checkbox
          ...
          {columns.map((col, index) => {
            ...
            return (
              <div
                ...
                style={{
                  backgroundColor: `${col.color}10`, // 10% opacity
                    ...
                    return (
                      ...
                      >
                        ...
                        <Card
                          ...
                          hover:shadow-md ${isDone ? "bg-gray-50" : "bg-white"}
                          ...
                          <div className="flex justify-between items-start mb-2">
                            ...
                            {task.dueDate && (
                              <Tag
                                ...
                                className={
                                  shouldHighlightDue ? "animate-pulse" : ""
                                }
                                style={{
                                  borderRadius: "10px",
                                  fontSize: "10px",
                              ...
                              {assignees.map((a) => (
                                <Tooltip title={a.name} key={a.id}>
                                  {a.avatarUrl ? (
                                    ...
                                    <div className="w-5 h-5 rounded-full bg-blue-100 text-blue-700 text-[10px] font-semibold flex items-center justify-center ring-1 ring-white">
                                      {(a.avatar || "U").slice(0, 1).toUpperCase()}
                                    </div>
                                  )}
                                </Tooltip>
                              ))}
